@section('pageTitle', 'Delivery Loading')
...
<div class="modal-content">
    ...
    <form class="form-horizontal" id="formData">
        <div class="modal-body">
            ...
            <div class="form-group">
                <div class="row">
                    <label class="col-md-4 control-label">Truck Identification</label>
                    <div class="col-md-8">
            ...
            <div class="form-group">
                <div class="row">
                    <label class="col-md-4 control-label">Line Number</label>
                    <div class="col-md-8">
                      <select class="form-control" id="linenumber" name="linenumber">
...
$(document).ready(function() {
    ...
    var tableColumn = [
        ...
        { data: "ship_quantity_check" },
        { data: "ship_quantity_check" },
        { data: "ship_quantity_check", width: 20, sortable: false}
...

            {
                           ...
                           },
                           {
                               ...
                               filename: function(){
                                    var d = new Date();
                                    var n = d.getTime();
                                    return 'Orbit Delivery Loading' + " " + d;
                                }
                           },
                           {
                               "extend": 'csv',
